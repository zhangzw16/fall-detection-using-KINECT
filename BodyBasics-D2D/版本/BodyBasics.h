...
private:
	...
	float                   Floor_Depth;
	bool                    Floor_Depth_Updating;
	int                     Floor_Depth_Updating_state;
	int                     Floor_Depth_Updating_threshold;

	//Begin Detection
	int                     Begin_State;
	int                     Begin_threshold;
	float                   Depth_Computing_Sum;
	float                   Pos_Height_Computing_Sum;

	// Current Pos
	float                   spineBaseheight_current;
	float                   chestAngle_current;
	float                   hei_current;
	float                   leftHipAngle_current;
	float                   rightHipAngle_current;
	float                   leftKneeAngle_current;
	float                   rightKneeAngle_current;
	float                   chestKneeAngle_current;
